...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden p-4">
            {/* Background Orbs */}
            <div className="orb w-[500px] h-[500px] top-[-15%] right-[-10%] bg-secondary/25 animate-blob" />
            <div className="orb w-[400px] h-[400px] top-[-10%] left-[-10%] bg-primary/25 animate-blob" style={{ animationDelay: '2s' }} />
            <div className="orb w-[350px] h-[350px] bottom-[-10%] right-[20%] bg-accent-teal/20 animate-blob" style={{ animationDelay: '4s' }} />
            ...
            >
                ...
                >
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-brand shadow-glow-secondary mb-4 animate-pulse-glow">
                        <Sparkles className="w-8 h-8 text-white" />
                    </div>
                    <h1 className="text-4xl font-extrabold gradient-text tracking-tight">MindWell</h1>
                    <p className="text-slate-500 dark:text-slate-400 text-sm mt-1 font-medium tracking-wide">Start your wellness journey today</p>
                </motion.div>

                <div className="glass-panel p-8">
                    <div className="mb-7">
                        <h2 className="text-2xl font-bold text-slate-800 dark:text-white">Create your account ✨</h2>
                        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">It's free and takes less than a minute</p>
                    </div>
